CopywriteRshallow <- function(sample.control, destination.folder, reference.folder,
...
#
#		#####################################
#		### Generate mock peaks bed file! ###
#		#####################################
#		
#		merged.bed<-matrix(data=0, ncol=5, nrow=2)
#		merged.bed[1,1]<-1
#		merged.bed[1,2]<-1
#		merged.bed[1,3]<-2
#		merged.bed[1,4]<-"MACS_peak_1"
#		merged.bed[1,5]<-50
#		merged.bed[2,1]<-1
#		merged.bed[2,2]<-3
#		merged.bed[2,3]<-4
#		merged.bed[2,4]<-"MACS_peak_2"
#		merged.bed[2,5]<-50
#
#        ## Write data
